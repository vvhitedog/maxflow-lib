...
void solve_unwrapping_problem(int npt, const int_vector &arcs,
  ...
  while ( iter++ < max_iter ) {
    ...
    fprintf(stderr,"setup time: %f, maxflow timer: %f\n",timer_setup.elapsed_seconds(),
            timer_maxflow.elapsed_seconds() );
...
int main(int argc, char *argv[]) {
  ...
  solve_unwrapping_problem<int_vector,maxflowlib::GraphBK<int,int,int,int> >(npt, arcs, ambigs, x);
